...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post servicios_url, params: { servicio: { costo: @servicio.costo, descripcion: @servicio.descripcion, estatus: @servicio.estatus } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { costo: @servicio.costo, descripcion: @servicio.descripcion, estatus: @servicio.estatus } }
